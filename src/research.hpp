...
enum e_research_id
{
    ...
    RESEARCH_INTERSTELLAR_TRADE,
    RESEARCH_UNLOCK_LUNA,
    RESEARCH_FASTER_CRAFTING,
    RESEARCH_SHIELD_TECHNOLOGY,
    RESEARCH_EMERGENCY_ENERGY_CONSERVATION,
    RESEARCH_REPAIR_DRONE_TECHNOLOGY,
    RESEARCH_TRITIUM_EXTRACTION,
    RESEARCH_CAPITAL_SHIP_INITIATIVE,
    RESEARCH_AUXILIARY_FRIGATE_DEVELOPMENT,
    RESEARCH_ESCAPE_POD_LIFELINE
};
